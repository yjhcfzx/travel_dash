...
echo form_open_multipart('../' . uri_string(), $attributes);
 ?>
    ...
    <div class="control-group">
          <!-- Text input-->
          <label class="control-label" for="name"><?php echo $this->lang->line('link_name'); ?></label>
          <div class="controls">
            <input type="text"  class="input-xlarge required" name='name' id='name'  value='<?php echo $detail["name"];?>'>
          </div>
           <!-- Text input-->
          <label class="control-label" for="content"><?php echo $this->lang->line('link'); ?></label>
          <div class="controls">
            <input type="text"  class="input-xlarge required" name='content' id='content'  value='<?php echo $detail["content"];?>'>
          </div>
